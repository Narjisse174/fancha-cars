...
const features = [
  {
    ...
    description: 'Tous les véhicules proposés sont des modèles 2026, soigneusement entretenus.',
  },
  {
    icon: Gauge,
    title: 'Kilométrage illimité',
    description: 'Roulez sereinement sans avoir à compter chaque kilomètre. Aucune restriction.',
  },
  {
    icon: Shield,
    title: 'Assurance tous risques',
    description: 'Une couverture complète pour votre location, pour partir l\'esprit tranquille.',
  },
  {
    icon: Clock,
    title: 'Disponible 24h/24',
    description: 'Notre équipe est disponible à toute heure pour répondre à vos besoins.',
  },
  {
    icon: Truck,
    title: 'Livraison disponible',
    description: 'Nous livrons votre véhicule selon votre ville et disponibilités.',
  },
  {
    icon: Star,
    title: 'Service premium',
    description: 'Un accompagnement personnalisé du début à la fin de votre location.',
  },
];
